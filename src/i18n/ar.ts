...
مزمور 34:19  “كثيرة هي أحزان الصديق ومن جميعها ينجيه الرب.”`,
  ...
  // Quick slots
  quickSlotsIntro:هذه الأزرار الأربعة تسمح لك بالعودة فوراً إلى القراءات المتكررة لتتابع عدة أسفار في آن واحد: استخدم 1/2/3 لثلاثة مواضع، والعدسة للعودة إلى آخر مقطع (آية عشوائية أو نتيجة بحث).",
