...
const fr: TranslationDict = {
  ...
  // Aide / mode d'emploi pour Notes
  notesHelp: {
    title: 'Notes — mode d’emploi',
    intro:
    ...
    s2Title: '2. Ouvrir et revenir aux listes',
    s2Body:
    ...
    s3Title: '3. Ajouter des versets depuis la Bible',
    s3Body:
    ...
    s4Title: '4. Blocs de texte libres',
    s4Body:
      'En plus des versets, vous pouvez ajouter des blocs de texte (compte-rendus, plans, idées, prières, résumés, etc.). Le bouton « Ajouter un bloc de texte » (en haut et en bas de la liste) ouvre une grande zone d’édition. Le texte est enregistré comme un élément à part entière dans la liste, que vous pouvez ensuite modifier, déplacer ou supprimer.',

    s5Title: '5. Réorganiser les éléments',
    s5Body:
    ...
    s6Title: '6. Copier et partager une liste entière',
    s6Body:
    ...
    s7Title: '7. Partage par code TheWord',
    s7Body:
    ...
    s8Title: '8. Importer à partir d’un texte',
    s8Body:
    ...
    s9Title: '9. Gestion locale et confidentialité',
    s9Body:
    ...
    s10Title: '10. Idées d’utilisation',
    s10Body:
    ...
    ok: 'OK',
    helpButtonTitle: "Aide / Mode d'emploi",
    helpButtonAria: 'Aide sur la page Notes',
  },
