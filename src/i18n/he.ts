...
const he: TranslationDict = {
  ...
  aboutTitle: '',
  aboutDescription:
    'חפשו באופן מיידי מילים או ביטויים בכל כתבי הקודש, פתחו את התוצאות בעמוד הקריאה והעתיקו או שתפו פסוק בנגיעה אחת.',
  aboutIntro: `למה The Word?

יצרתי את The Word כדי שאוכל לקרוא במקביל כמה מספרי התנ״ך, בלי לאבד את רצף הקריאה שלי. עם הזמן נוספו אפשרויות נוספות, תמיד מתוך אותה מטרה: לעזור לכל אדם לקרוא, להגות, לזכור וליישם את דבר אלוהים.

הרצון שלי

בעולם שבו קולות רבים כל כך מנסים להשפיע עלינו, הרצון שלי פשוט: לעודד כל אדם לחזור ישירות אל כתבי הקודש, בלב כן, ולחפש בהם את האמת.

תפילתי היא שהיישומון הזה יעזור לכם לגלות את אהבת אלוהים, להכיר את ישוע המשיח ולהבין מה הוא עשה כדי לפייס בינינו לבין אלוהים.

קראו את דברו. בחנו אותו בתשומת לב. בקשו מאלוהים להדריך אתכם, ולאחר מכן השיבו לקריאתו באמונה, בתשובה ובציות.

״אם תעמדו בדברי, באמת תלמידיי אתם; ותדעו את האמת, והאמת תשחרר אתכם.״
...
יוחנן 8:31-32`,
  ...
  versionsFootnote:
    'על אודות הטקסטים: נוסחי כתבי הקודש הכלולים ביישומון משמשים בהתאם לרישיונות שלהם. רק נוסח Louis Segond 1910 עודכן בשנת 2025 מבחינת הדקדוק ואוצר המילים, תוך הקפדה מלאה על נאמנות לכתבי היד המקוריים.',

  // Quick slots
  quickSlotsIntro:
    'ארבעת הכפתורים האלה מאפשרים לחזור מיד למקומות שאתם קוראים לעיתים קרובות ולקרוא כמה ספרים במקביל: השתמשו ב־1/2/3 עבור שלושה מקומות נפרדים, ובזכוכית המגדלת כדי לחזור לקטע האחרון (פסוק אקראי או תוצאת חיפוש).',
